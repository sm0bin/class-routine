...
const Usage = () => {
    return (
        <section className="max-w-7xl mx-4 md:mx-8 lg:mx-auto">
            <Helmet>
                <title>Class Routine | Usage</title>
            </Helmet>
            <h2 className="font-bold text-4xl mt-6 mb-10 text-center">Using Steps</h2>
            <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
                ...
                <li>
                    ...
                    <div className="timeline-end mb-10">
                        ...
                        <div className="text-lg font-black">Set Your Dept Schedule</div>
                ...
                <li>
                    ...
                    <div className="timeline-start md:text-end mb-10">
                        ...
                        <div className="text-lg font-black">Generate Keys</div>
                ...
                <li>
                    ...
                    <div className="timeline-end mb-10">
                        ...
                        <div className="text-lg font-black">Easy to Update By Teachers</div>
                ...
                <li>
                    ...
                    <div className="timeline-start md:text-end mb-10">
                        ...
                        <div className="text-lg font-black">Easy to View</div>
